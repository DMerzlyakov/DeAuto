...
/**
 * Контроллер JavaFx для окна "добавление работника"
 */
public class EmployeeAddController extends SuperController {
    ...
    private boolean isInputValid() {
        ...
        if (passwordField.getText() == null || passwordField.getText().length() == 0) {
            errorMessage += "Не валиден пароль\n";
        }
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            connectionEmp.addEmployee(data);
